 ...
 */
public class LessonScontraint_AND extends AbstractLessonConstraint {
    private final AbstractLessonConstraint a;
    private final AbstractLessonConstraint b;

    public LessonScontraint_AND(AbstractLessonConstraint a, AbstractLessonConstraint b) {
        super(false);
        this.a = a;
        this.b = b;
    }
