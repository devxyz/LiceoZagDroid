...
public class FastSetRoomData_ImplBits implements FastSetRoomData {
    private long bit = 0;
    ...
    public static void main(String[] args) {
        FastSetRoomData_ImplBits f = new FastSetRoomData_ImplBits();
        f.useRoom(RoomData.A1);
        f.useRoom(RoomData.A2);
        f.freeRoom(RoomData.A2);
        //f.useRoom(RoomData.E29sharp);
    ...
    private class RoomDataIterator implements Iterator<RoomData> {
        ...
        public void remove() {
            if (!hasNext())
                throw new NoSuchElementException();
            FastSetRoomData_ImplBits.this.freeRoom(RoomData.values()[index]);
        }
    }
}
