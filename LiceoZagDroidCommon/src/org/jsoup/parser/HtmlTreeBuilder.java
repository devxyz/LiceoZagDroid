...
class HtmlTreeBuilder extends TreeBuilder {
    ...
    private Element contextElement; // fragment parseFromHtml context -- could be null even if fragment parsing
    ...
    void maybeSetBaseUri(Element base) {
        if (baseUriSetFromDoc) // only listen to the first <base href> in parseFromHtml
            return;
