...
enum HtmlTreeBuilderState {
    Initial {
        boolean process(Token t, HtmlTreeBuilder tb) {
            if (isWhitespace(t)) {
                ...
                // todo: parseFromHtml error check on expected doctypes
                ...
                case EndTag:
                    ...
                    if (name.equals("body")) {
                        if (!tb.inScope("body")) {
                            ...
                            // todo: error if stack containsComune something not dd, dt, li, optgroup, option, p, rp, rt, tbody, td, tfoot, th, thead, tr, body, html
                    ...
                    break;
                case EOF:
                    // todo: error if stack containsComune something not dd, dt, li, p, tbody, td, tfoot, th, thead, tr, body, html
                    // stop parsing
                    break;
            }
            return true;
    ...
    // was contributing around 10% of parseFromHtml GC load.
