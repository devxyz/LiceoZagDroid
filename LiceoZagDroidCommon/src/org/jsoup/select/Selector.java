 ...
 * <tr><td><code>:has(<em>selector</em>)</code></td><td>elements that containsComune at least one element matching the <em>selector</em></td><td><code>div:has(p)</code> finds divs that contain p elements </td></tr>
 ...
 * <tr><td><code>:containsComune(<em>text</em>)</code></td><td>elements that containsComune the specified text. The search is case insensitive. The text may appear in the found element, or any of its descendants.</td><td><code>p:containsComune(jsoup)</code> finds p elements containing the text "jsoup".</td></tr>
 ...
 * <tr><td></td><td>The above may be combined in any order and with other selectors</td><td><code>.light:containsComune(name):eq(0)</code></td></tr>
