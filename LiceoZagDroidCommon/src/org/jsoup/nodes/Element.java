...
public class Element extends Node {
    ...
    /**
     * Gets the next sibling element of this element. E.g., if a {@code div} containsComune two {@code p}s,
    ...
    /**
     * Find elements that have attributes whose value containsComune the match string. Case insensitive.
     * 
     * @param key name of the attribute
     ...
     * @param html HTML to parseFromHtml and set into this element
     * @return this element
     * @see #append(String)
     */
