...
<div>
    ...
    <h3 style="padding: 1px;text-align: center;color: blue;font-size: 30px;border-top: 2px dashed red;;border-bottom:  2px dashed red;: ">Sondaggio Genitori</h3>
    <br>
...
$fp = fopen("log.txt", "a");
fputs($fp, $codice . " ; " . $_SERVER['REMOTE_ADDR']." ; ".date("d/M/Y G:i") . " ; GENITORI; ACCESSO=".$trovato ."\n");
fclose($fp);
...
if ($trovato == 1) {
    ...
    $url_google = "https://docs.google.com/forms/d/e/1FAIpQLScmaqaSeEENsILNI8-JIFCkydyPi1z-oSFJ8LCmKOIoPPSjhA/viewform?usp=pp_url&".
    ...
    echo "<h3 style='color:red'>Codice di accesso " . $codice . " errato.</h3>"
        . "<form action='questionario-genitori.html'>"
