...
public class DownloadModuloFromCSVGoogle_PCTO extends DownloadModuloFromCSVGoogle {
    public DownloadModuloFromCSVGoogle_PCTO() {
    }
    ...
    protected String getLinkFileName(String[] row, List<String> links, int linkIndex) {
        return "relazione-pcto(" + getIdFile() + ").pdf";
    }
