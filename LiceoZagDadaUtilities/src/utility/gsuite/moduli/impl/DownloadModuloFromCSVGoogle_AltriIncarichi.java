...
public class DownloadModuloFromCSVGoogle_AltriIncarichi extends DownloadModuloFromCSVGoogle {
    public DownloadModuloFromCSVGoogle_AltriIncarichi() {
    }
    ...
    protected String getLinkFileName(String[] row, List<String> links, int linkIndex) {
        return "altri-incarichi " + row[4] + "+(" + getIdFile() + ").pdf";
    }
