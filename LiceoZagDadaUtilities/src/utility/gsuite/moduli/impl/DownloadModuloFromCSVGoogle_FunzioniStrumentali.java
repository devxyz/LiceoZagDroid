...
public class DownloadModuloFromCSVGoogle_FunzioniStrumentali extends DownloadModuloFromCSVGoogle {
    public DownloadModuloFromCSVGoogle_FunzioniStrumentali() {
    }
    ...
    protected String getLinkFileName(String[] row, List<String> links, int linkIndex) {
        return "funzione-strumentale(" + getIdFile() + ").pdf";
    }
