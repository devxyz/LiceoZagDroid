 ...
 */
public class MainImportaProgrammiSvoltiIPIA_201819 {
    ...
    public static void main(String[] args) throws IOException {
        File folder = new File("/Users/stefano/DATA/scuola/insegnamento/scuola-AS-2018-19/programmi_svolti/");
        String[] nomi = new String[]{
                "visforms_20190618_ipia.csv",
        };

        for (String nome : nomi) {
            File f = new File(folder, nome);
            File folderOut = new File(folder, "files");
            ...
            for (CSVRecord p : parse) {
                ...
                final String materia = p.get(10).replace("/", "-").replace("’", "");
                final String classe = p.get(8);
                final String sez = p.get(9).split(" ")[0];
                final String scuola = p.get(9).split(" ")[1];
