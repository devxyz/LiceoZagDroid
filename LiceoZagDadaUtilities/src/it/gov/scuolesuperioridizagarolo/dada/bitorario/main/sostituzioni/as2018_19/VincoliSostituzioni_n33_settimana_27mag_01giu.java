 ...
 */
public class VincoliSostituzioni_n33_settimana_27mag_01giu extends AbstractVincoliSostituzioni {
    public static void main(String[] args) throws IOException {
        final VincoliSostituzioni_n33_settimana_27mag_01giu l = new VincoliSostituzioni_n33_settimana_27mag_01giu();
    ...
    public VincoliSostituzioni_n33_settimana_27mag_01giu invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {
        dal = "27/05/2019";
        al = "01/06/2019";
...
*/
        l.add(new LessonConstraint_DocenteInAulaLIM(
                false, orarioTotale, "DEL SIGNORE", EGiorno.MERCOLEDI, EOra.PRIMA, EOra.SECONDA, EOra.TERZA));
