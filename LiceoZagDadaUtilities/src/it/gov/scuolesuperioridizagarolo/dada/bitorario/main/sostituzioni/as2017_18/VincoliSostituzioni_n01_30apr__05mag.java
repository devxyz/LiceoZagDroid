...
public class VincoliSostituzioni_n01_30apr__05mag extends AbstractVincoliSostituzioni {
    ...
    public VincoliSostituzioni_n01_30apr__05mag invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {

        {
            ...
            l.add(new LessonConstraint_ClasseFermaInAulaDidattica_labsToo(_4C, _A2, EGiorno.values()));
            ...
            */
            ...
            for (ClassData c : ClassesAndRoomContainer.getAllClasses()) {
                orarioTotale.classeInVisitaDidattica("Assemblea d'Istituto - LICEO", c, EGiorno.MERCOLEDI, EOra.SECONDA, EOra.TERZA, EOra.QUARTA, EOra.QUINTA);
                orarioTotale.classeInVisitaDidattica("Chiusura 30 Aprile", c, EGiorno.LUNEDI, EOra.PRIMA, EOra.SECONDA, EOra.TERZA, EOra.QUARTA, EOra.QUINTA);
                orarioTotale.classeInVisitaDidattica("Chiusura 1 Maggio", c, EGiorno.MARTEDI, EOra.PRIMA, EOra.SECONDA, EOra.TERZA, EOra.QUARTA, EOra.QUINTA);
            }

            //Lazio Innova SPA
            l.add(new LessonConstraint_AulaNonDisponibile(_A5_DIS, EGiorno.GIOVEDI, EOra.SECONDA, EOra.TERZA, EOra.QUARTA, EOra.QUINTA));
            orarioTotale.classeInVisitaDidattica("Incontro Lazio Innova SPA (3 maggio)", _5A, EGiorno.GIOVEDI, EOra.SECONDA, EOra.TERZA, EOra.QUARTA, EOra.QUINTA);
