 ...
 */
public class VincoliSostituzioni_2021_n13_settimana_11nov_16gen_100percentoDAD extends AbstractVincoliSostituzioni {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final VincoliSostituzioni_2021_n13_settimana_11nov_16gen_100percentoDAD l = new VincoliSostituzioni_2021_n13_settimana_11nov_16gen_100percentoDAD();

        //if (true) throw new IllegalArgumentException("STOP DEBUG");
        MotoreSostituzioneAule3.doTaskFromTXT_CSV(
                l,
                new File(root, "13-27-15.01/Orario Classi Completo.txt"),
                new File(root, "13-27-15.01/Orario Tabella Globale.csv"),
                new File(root, "13-27-15.01/Orario Sostegno Orizzontale Semplice.txt"),
    ...
    protected void preOrarioBeforeAssignment(final BitOrarioGrigliaOrario orarioTotale) {
        ...
        for (ClassData c : ClassData.values()) {
            BitOrarioOraLezione l = orarioTotale.getLezioneInClasse(EOra.PRIMA, EGiorno.GIOVEDI, c);
            System.out.println(c.className+"\t"+l.getDocentePrincipale()+"\t"+l.getMateriaPrincipale());
        }
...
*/
    ...
    public VincoliSostituzioni_2021_n13_settimana_11nov_16gen_100percentoDAD invoke(final BitOrarioGrigliaOrario orarioTotale,
