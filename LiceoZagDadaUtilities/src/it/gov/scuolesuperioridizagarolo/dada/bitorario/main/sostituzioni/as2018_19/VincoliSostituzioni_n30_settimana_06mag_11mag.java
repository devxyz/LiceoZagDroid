 ...
 */
public class VincoliSostituzioni_n30_settimana_06mag_11mag extends AbstractVincoliSostituzioni {
    public static void main(String[] args) throws IOException {
        final VincoliSostituzioni_n30_settimana_06mag_11mag l = new VincoliSostituzioni_n30_settimana_06mag_11mag();
    ...
    public VincoliSostituzioni_n30_settimana_06mag_11mag invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {
        dal = "06/05/2019";
        al = "11/05/2019";
...
*/
        ...
        for (EGiorno giorno : new EGiorno[]{EGiorno.LUNEDI, EGiorno.MARTEDI, EGiorno.MERCOLEDI}) {
            orarioTotale.classeInVisitaDidattica("viaggio d’istruzione a Firenze", ClassData.CLASS_3B, giorno, EOra.values());
            orarioTotale.classeInVisitaDidattica("viaggio d’istruzione a Firenze", ClassData.CLASS_3C, giorno, EOra.values());
        }

        for (EGiorno giorno : new EGiorno[]{EGiorno.LUNEDI, EGiorno.MARTEDI, EGiorno.MERCOLEDI, EGiorno.GIOVEDI}) {
            orarioTotale.classeInVisitaDidattica("viaggio d’istruzione Veneto - Padova e Ville Palladiane sul Brenta", ClassData.CLASS_4A, giorno, EOra.values());
            orarioTotale.classeInVisitaDidattica("viaggio d’istruzione Veneto - Padova e Ville Palladiane sul Brenta", ClassData.CLASS_4B, giorno, EOra.values());
            orarioTotale.classeInVisitaDidattica("viaggio d’istruzione Veneto - Padova e Ville Palladiane sul Brenta", ClassData.CLASS_4C, giorno, EOra.values());
            orarioTotale.classeInVisitaDidattica("viaggio d’istruzione Veneto - Padova e Ville Palladiane sul Brenta", ClassData.CLASS_4D, giorno, EOra.values());
            orarioTotale.classeInVisitaDidattica("viaggio d’istruzione Veneto - Padova e Ville Palladiane sul Brenta", ClassData.CLASS_4E, giorno, EOra.values());
        }

        l.add(new LessonConstraint_AulaNonDisponibile(RoomData.B8, EGiorno.MARTEDI, EOra.values()));
        l.add(new LessonConstraint_AulaNonDisponibile(RoomData.B10, EGiorno.MARTEDI, EOra.values()));
        l.add(new LessonConstraint_AulaNonDisponibile(RoomData.B11, EGiorno.MARTEDI, EOra.values()));
        l.add(new LessonConstraint_AulaNonDisponibile(RoomData.F31_PALESTRA, EGiorno.MARTEDI, EOra.values()));
        l.add(new LessonConstraint_AulaNonDisponibile(RoomData.F31_PALESTRA, EGiorno.MERCOLEDI, EOra.values()));
