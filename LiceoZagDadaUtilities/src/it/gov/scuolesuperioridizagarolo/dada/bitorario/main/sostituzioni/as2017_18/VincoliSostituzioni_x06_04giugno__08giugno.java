 ...
 */
@Deprecated
public class VincoliSostituzioni_x06_04giugno__08giugno extends AbstractVincoliSostituzioni {
    public static void main(String[] args) throws IOException {
        final VincoliSostituzioni_x06_04giugno__08giugno l = new VincoliSostituzioni_x06_04giugno__08giugno();
        MotoreSostituzioneAule2.doTask(l);

    }

    public VincoliSostituzioni_x06_04giugno__08giugno invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {
        //vincoli base
