 ...
 */
public class VincoliSostituzioni_n31_settimana_13mag_19mag extends AbstractVincoliSostituzioni {
    public static void main(String[] args) throws IOException {
        final VincoliSostituzioni_n31_settimana_13mag_19mag l = new VincoliSostituzioni_n31_settimana_13mag_19mag();
        MotoreSostituzioneAule3.doTaskFromJSon(
                l,
                new File("/Users/stefano/Dropbox/Circolari Scolastiche LICEO/AS 2018.19/Orario Scolastico/orario-definitivo/DEFINITIVO_timetable_20181114222113_12.11.2018_09.06.2019.json.zip"),
    ...
    public VincoliSostituzioni_n31_settimana_13mag_19mag invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {
        dal = "13/05/2019";
        al = "19/05/2019";
...
*/
        ...
        //compito latino
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_3G, _D25, EGiorno.MARTEDI, EOra.TERZA, EOra.QUARTA));


        //INVALSI
        //LUNEDI'
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2D, _A4_INF, EGiorno.LUNEDI, EOra.PRIMA, EOra.SECONDA));
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2G, _A1, EGiorno.LUNEDI, EOra.PRIMA, EOra.SECONDA));
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2F, _A1, EGiorno.LUNEDI, EOra.TERZA, EOra.QUARTA));
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2B, _A1, EGiorno.LUNEDI, EOra.QUINTA, EOra.SESTA));

        //MARTEDI'
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2G, _A4_INF, EGiorno.MARTEDI, EOra.PRIMA, EOra.SECONDA));
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2E, _A1, EGiorno.MARTEDI, EOra.PRIMA, EOra.SECONDA));
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2C, _A1, EGiorno.MARTEDI, EOra.TERZA, EOra.QUARTA));
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2D, _A1, EGiorno.MARTEDI, EOra.QUINTA, EOra.SESTA));

        //MERCOLEDI'
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2A, _A1, EGiorno.MERCOLEDI, EOra.PRIMA, EOra.SECONDA));
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2F, _A1, EGiorno.MERCOLEDI, EOra.TERZA, EOra.QUARTA));
        orarioTotale.classeInVisitaDidattica("Viaggio Istruzione Roma", ClassData.CLASS_2H, EGiorno.MERCOLEDI, EOra.values());
        l.add(new LessonConstraint_AulaNonDisponibile(RoomData.A1, EGiorno.MERCOLEDI, EOra.QUINTA));


        //GIOVEDI'
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2E, _A4_INF, EGiorno.GIOVEDI, EOra.PRIMA, EOra.SECONDA));
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2C, _A1, EGiorno.GIOVEDI, EOra.PRIMA, EOra.SECONDA));
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2B, _A1, EGiorno.GIOVEDI, EOra.TERZA, EOra.QUARTA));
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2H, _A1, EGiorno.GIOVEDI, EOra.QUINTA, EOra.SESTA));

        //VENERDI'
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2H, _A1, EGiorno.VENERDI, EOra.PRIMA, EOra.SECONDA));
        l.add(new LessonConstraint_ClasseFermaInAulaDidatticaPerOre_labsToo(ClassData.CLASS_2A, _A1, EGiorno.VENERDI, EOra.TERZA, EOra.QUARTA));
...
*/
        ...
        //====================================================================================================================================
        l.add(new LessonConstraint_DocenteFermoInAulaDidatticaPerOre(
                false, "FERRIGNO", new RoomData[]{RoomData.A6, RoomData.A4_INF, RoomData.A1, RoomData.A7, RoomData.A5sharp}, EGiorno.values(), EOra.values()));

        l.add(new LessonConstraint_DocenteFermoInAulaDidatticaPerOre(
                false, "DI GIOIA", new RoomData[]{RoomData.A6, RoomData.A4_INF, RoomData.A1, RoomData.A7, RoomData.A5sharp}, EGiorno.values(), EOra.values()));
