 ...
 */
public class VincoliSostituzioni_1920_n6_settimana_con_aree_disciplinari extends AbstractVincoliSostituzioni {
    public static void main(String[] args) throws IOException {
        final VincoliSostituzioni_1920_n6_settimana_con_aree_disciplinari l = new VincoliSostituzioni_1920_n6_settimana_con_aree_disciplinari();
...
//        if (true) throw new IllegalArgumentException("ERRORE");
    ...
    public VincoliSostituzioni_1920_n6_settimana_con_aree_disciplinari invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {
