 ...
 */
public class VincoliSostituzioni_n14_settimana_10dic_15dic extends AbstractVincoliSostituzioni {
    public static void main(String[] args) throws IOException {
        final VincoliSostituzioni_n14_settimana_10dic_15dic l = new VincoliSostituzioni_n14_settimana_10dic_15dic();
...
*/
    ...
    public VincoliSostituzioni_n14_settimana_10dic_15dic invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {
        dal = "10/12/2018";
        al = "15/12/2018";
...
*/
        ...
        l.add(new LessonConstraint_AulaNonDisponibile(RoomData.A5_DIS, EGiorno.SABATO, EOra.TERZA, EOra.QUARTA, EOra.QUINTA));
        l.add(new LessonConstraint_AulaNonDisponibile(RoomData.A7, EGiorno.SABATO, EOra.TERZA, EOra.QUARTA, EOra.QUINTA));

        orarioTotale.classeInVisitaDidattica("Incontro in aula disegno A5 - incontro prof Gaetano Piccolo sul tema Il Discernimento, imparare a decidere", ClassData.CLASS_5A, EGiorno.SABATO, EOra.QUARTA, EOra.QUINTA);
        orarioTotale.classeInVisitaDidattica("Incontro in aula disegno A5 - incontro prof Gaetano Piccolo sul tema Il Discernimento, imparare a decidere", ClassData.CLASS_5B, EGiorno.SABATO, EOra.QUARTA, EOra.QUINTA);
        orarioTotale.classeInVisitaDidattica("Incontro in aula disegno A5 - incontro prof Gaetano Piccolo sul tema Il Discernimento, imparare a decidere", ClassData.CLASS_5C, EGiorno.SABATO, EOra.QUARTA, EOra.QUINTA);
