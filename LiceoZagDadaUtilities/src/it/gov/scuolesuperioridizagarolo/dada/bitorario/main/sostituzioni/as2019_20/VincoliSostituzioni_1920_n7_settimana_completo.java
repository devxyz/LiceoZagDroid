 ...
 */
public class VincoliSostituzioni_1920_n7_settimana_completo extends AbstractVincoliSostituzioni {
    public static void main(String[] args) throws IOException {
        final VincoliSostituzioni_1920_n7_settimana_completo l = new VincoliSostituzioni_1920_n7_settimana_completo();
    ...
    protected void preOrarioBeforeAssignment(final BitOrarioGrigliaOrario orarioTotale) {
        Map<EOra, ArrayList<BitOrarioOraLezione>> report = ReportDocentiAssenti.report(orarioTotale, EGiorno.LUNEDI,
                "X_MATFIS_1", "X_MATFIS_2", "X_PART_TIME_A019", "PANEPUCCIA A."

        );

        System.out.println(ReportDocentiAssenti.stampaReport(report));
    ...
    public VincoliSostituzioni_1920_n7_settimana_completo invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {
