 ...
 */
public class VincoliSostituzioni_2021_n12bis_settimana_30nov_09gen_100_PERCENTO extends AbstractVincoliSostituzioni {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final VincoliSostituzioni_2021_n12bis_settimana_30nov_09gen_100_PERCENTO l = new VincoliSostituzioni_2021_n12bis_settimana_30nov_09gen_100_PERCENTO();

        //if (true) throw new IllegalArgumentException("STOP DEBUG");
        MotoreSostituzioneAule3.doTaskFromTXT_CSV(
                l,
                new File(root, "12-27-15.01/Orario Classi Completo.txt"),
                new File(root, "12-27-15.01/Orario Tabella Globale.csv"),
                new File(root, "12-27-15.01/Orario Sostegno Orizzontale Semplice.txt"),
...
*/
    ...
    public VincoliSostituzioni_2021_n12bis_settimana_30nov_09gen_100_PERCENTO invoke(final BitOrarioGrigliaOrario orarioTotale,
