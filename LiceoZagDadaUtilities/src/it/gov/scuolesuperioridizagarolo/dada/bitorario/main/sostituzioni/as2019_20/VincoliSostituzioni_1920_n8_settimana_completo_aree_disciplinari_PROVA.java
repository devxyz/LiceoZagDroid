 ...
 */
public class VincoliSostituzioni_1920_n8_settimana_completo_aree_disciplinari_PROVA extends AbstractVincoliSostituzioni {
    public static void main(String[] args) throws IOException {
        final VincoliSostituzioni_1920_n8_settimana_completo_aree_disciplinari_PROVA l = new VincoliSostituzioni_1920_n8_settimana_completo_aree_disciplinari_PROVA();
...
//        if (true) throw new IllegalArgumentException("ERRORE");
    ...
    public VincoliSostituzioni_1920_n8_settimana_completo_aree_disciplinari_PROVA invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {
