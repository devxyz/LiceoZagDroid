...
import it.gov.scuolesuperioridizagarolo.dada.bitorario.constraint.impl.CheckForTeacher_ClassiRipetute;
import it.gov.scuolesuperioridizagarolo.dada.bitorario.constraint.impl.CheckForTeacher_LezioniMateriaRipetute;
import it.gov.scuolesuperioridizagarolo.dada.bitorario.constraint.impl.CheckForTeacher_OreBucheTotali;
 ...
 */
public class VincoliSostituzioni_1920_n5_prove extends AbstractVincoliSostituzioni {
    public static void main(String[] args) throws IOException {
        final VincoliSostituzioni_1920_n5_prove l = new VincoliSostituzioni_1920_n5_prove();
        MotoreSostituzioneAule3.doTaskFromTXT(
                l,
                new File("/Users/stefano/Dropbox/Circolari Scolastiche LICEO/orario20192020/05 definitivo 06 ottobre/Orario Allocazione Aule.txt"),
                null,
                new File("/Users/stefano/Dropbox/Circolari Scolastiche LICEO/orario20192020/05 definitivo 06 ottobre/Orario Professori Orizzontale Semplice.txt"),
                null, null, new File("/Users/stefano/Dropbox/Circolari Scolastiche LICEO/orario20192020/05 definitivo 06 ottobre/output"),
    ...
    protected void preOrarioBeforeAssignment(final BitOrarioGrigliaOrario orarioTotale) {
        ...
        for (String d : orarioTotale.getDocenti()) {
            System.out.print(d + "\t ");
            for (ClassData classData : ClassData.values()) {
                Set<String> materieDocenteClasse = orarioTotale.getMaterieDocenteClasse(d, classData);
                for (String m : materieDocenteClasse) {
                    if (materieDocenteClasse.size() > 0) {
                        System.out.print(classData + " (" + m + ") - ");
                    }
                }
            }
            System.out.println();
    ...
    public VincoliSostituzioni_1920_n5_prove invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {
