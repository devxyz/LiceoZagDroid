 ...
 */
public class VincoliSostituzioni_n18_settimana_28gen_02feb extends AbstractVincoliSostituzioni {
    public static void main(String[] args) throws IOException {
        final VincoliSostituzioni_n18_settimana_28gen_02feb l = new VincoliSostituzioni_n18_settimana_28gen_02feb();
    ...
    public VincoliSostituzioni_n18_settimana_28gen_02feb invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {
        dal = "28/1/2019";
        al = "2/2/2019";
...
*/
        ...
        orarioTotale.classeInVisitaDidattica("incontro con il Prof. Gaetano Piccolo sul tema Il Discernimento, imparare a decidere",
                ClassData.CLASS_4B, EGiorno.SABATO, EOra.QUINTA, EOra.QUARTA);
        orarioTotale.classeInVisitaDidattica("incontro con il Prof. Gaetano Piccolo sul tema Il Discernimento, imparare a decidere",
                ClassData.CLASS_4C, EGiorno.SABATO, EOra.QUINTA, EOra.QUARTA);
        orarioTotale.classeInVisitaDidattica("incontro con il Prof. Gaetano Piccolo sul tema Il Discernimento, imparare a decidere",
                ClassData.CLASS_3A, EGiorno.SABATO, EOra.QUINTA, EOra.QUARTA);
