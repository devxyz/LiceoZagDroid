 ...
 */
public class VincoliSostituzioni_nxx_settimana_base extends AbstractVincoliSostituzioni {
    public static void main(String[] args) throws IOException {
        final VincoliSostituzioni_nxx_settimana_base l = new VincoliSostituzioni_nxx_settimana_base();
    ...
    public VincoliSostituzioni_nxx_settimana_base invoke(final BitOrarioGrigliaOrario orarioTotale, final LessonConstraintContainer l) {
        dal = "12/11/2018";
        al = "09/06/2019";
