 ...
 */
public abstract class CheckForTeacher {
    public Map<String, String> check(BitOrarioGrigliaOrario l) {
        final TreeSet<String> docenti = l.getDocenti();
    ...
    protected abstract String check(BitOrarioGrigliaOrario l, String nomeDocente);
}
