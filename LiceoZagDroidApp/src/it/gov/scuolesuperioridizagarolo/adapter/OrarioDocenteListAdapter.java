...
public class OrarioDocenteListAdapter extends AbstractOrarioListAdapter {
    ...
    public OrarioDocenteListAdapter(Activity a, String docente, BitOrarioGrigliaOrario orario, EGiorno giorno) {
    ...
    public BitOrarioOraLezione getItem(int position) {
        ...
        final BitOrarioOraLezione lezioneInClasse = orario.getLezioneConDocente(ora1, giorno, docente);
