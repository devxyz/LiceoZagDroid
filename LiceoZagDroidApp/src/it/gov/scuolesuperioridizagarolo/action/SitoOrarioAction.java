 ...
 */
public class SitoOrarioAction implements ActivityAction {
    @Override
    public void doTask(MainMenuActivity activity, DataMenuInfo item, Bundle bundle) {
        Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse(activity.getString(R.string.url_website_orario)));
