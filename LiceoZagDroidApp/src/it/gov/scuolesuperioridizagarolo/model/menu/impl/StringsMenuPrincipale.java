...
public class StringsMenuPrincipale {
    ...
    public static final DataMenuInfo ORARIO_CLASSI = new DataMenuInfo(
            ...
            new TreeSet<>(Arrays.<DataMenuInfoFlag>asList(DataMenuInfoFlag.SUB_ITEM, DataMenuInfoFlag.SHOW_STUDENTI)));
    ...
    public static final DataMenuInfo R_E_FAMIGLIE = new DataMenuInfo(
            ...
            new TreeSet<>(Arrays.<DataMenuInfoFlag>asList(DataMenuInfoFlag.SUB_ITEM, DataMenuInfoFlag.SHOW_GENITORI, DataMenuInfoFlag.SHOW_STUDENTI)));
